                                ...
                                <div class="art-content-layout layout-item-1">
                                  <div class="art-content-layout-row">
                                    <div class="art-layout-cell layout-item-2" style="width: 30%;">
                                      ...
                                      {gui->image href="{$shop_event.event_image}" width=120 height=110 align='left' class="magnify has-tooltip" border="0" style="" alt="{$shop_event.event_name} in {$shop_event.ort_city}" title="{$shop_event.event_name} in {$shop_event.ort_city}" border="0"}
                                           </a>
                                    </div>
