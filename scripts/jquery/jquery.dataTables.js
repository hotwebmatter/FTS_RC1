...
(/** @lends <global> */function( window, document, undefined ) {
  ...
  (/** @lends <global> */function( $ ) {
    ...
    */
    ...
    function _fnGridComplete( oSettings, aoData )
    {
      _fnCallbackFire( oSettings, 'aoGridComplete', 'GridComplete', [aoData] );
    }
    ...
    function _fnFeatureHtmlTable ( oSettings )
    {
      ...
      */
      ...
      if ( oSettings.oScroll.bAutoCss )
      {
        ...
        nScrollBody.style.overflowY = "scroll";
      }
    ...
    DataTable = function( oInit )
    {
      ...
      */
      this.oApi = {
        ...
        "_fnGridComplete": _fnGridComplete,  //NVDS
      ...
      this.each(function() {
        ...
        _fnCallbackReg( oSettings, 'aoGridComplete',       oInit.fnGridComplete,      'user' );
      ...
      */
      "fnFormatNumber": function ( toFormat ) {
        ...
        for ( var i=0 ; i<iLen ; i++ )
        {
          if ( i%3 === 0 && i !== 0 )
          {
  //          out = this.language.sInfoThousands+out;
          }
          out = a[iLen-i-1]+out;
        }
        return out;
      ...
      "fnServerData": function ( url, data, callback, settings ) {
        settings.jqXHR = $.ajax( {
          ...
          "success": function (json) {
            ...
            callback( json );
            _fnGridComplete(settings,json); //NVDS
          },
          "dataType": "json",
          "cache": false,
